...
### Dependencies
- Bump `actions/checkout` from 4 to 7 ([#13](https://github.com/Cray-HPE/bos-reporter/pull/13), [#15](https://github.com/Cray-HPE/bos-reporter/pull/15))
- Bump `actions/checkout` from 4 to 5 ([#13](https://github.com/Cray-HPE/bos-reporter/pull/13))
- Bump `stefanzweifel/git-auto-commit-action` from 5 to 7 ([#14](https://github.com/Cray-HPE/bos-reporter/pull/14))
